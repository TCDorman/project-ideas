...
class Graph(abc.ABC):
    ...
    @abc.abstractmethod
    def get_adjcent_vertices(self, v):
        pass
...
class AdjacencySetGraph(Graph):
    ...
    def add_adjacent_vertices(self, v):
    ...
    def get_indegree(self, v):
        ...
        for i in range(self.numVertices):
            if v in self.get_adjcent_vertices(i):
                indegree = indegree + 1
    ...
    def display(self):
        for i in range(self.numVertices):
            for v in self.get_adjcent_vertices(i):
                print(i, "-->", v)
...
for i in range(4):
    print("Adjacent to: ", i, g.get_adjcent_vertices(i))

for i in range(4):
    print("Indegree: ", i, g.get_indegree(i))

for i in range(4):
    for j in g.get_adjcent_vertices(i):
